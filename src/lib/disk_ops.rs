...
pub fn write_op_log(stream: &mut BufWriter<File>, db_id: u64, key: u64, opp: ReplicateOpp, opp_id: u64) -> u64 {
...
mod tests {
    ...
    fn should_write_op_log_and_return_opp_id() {
        ...
        let opp_id = write_op_log(&mut f, 1, 1, ReplicateOpp::Update, Databases::next_op_log_id());
        let opp_id1 = write_op_log(&mut f, 1, 1, ReplicateOpp::Update, Databases::next_op_log_id());
