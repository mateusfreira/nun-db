...
pub mod helpers {
    ...
    pub const SECOUNDARY2_HTTP_ADDRESS: &'static str = "127.0.0.1:3059";
    pub const SECOUNDARY2_TCP_ADDRESS: &'static str = "127.0.0.1:3016";
    pub const SECOUNDARY2_WS_ADDRESS: &'static str = "127.0.0.1:3060";
    pub const SECOUNDAR2_HTTP_URI: &'static str = "http://127.0.0.1:3059";

    pub const REPLICATE_SET_ADDRS: &'static str = "127.0.0.1:3017,127.0.0.1:3018";
    ...
    pub fn clean_env() {
        ...
        let clen_cmd = cmd.args(["-c", "rm -Rf /tmp/dbs&&rm -Rf /tmp/dbs1&&rm -Rf /tmp/dbs2/&&mkdir  /tmp/dbs2/&&mkdir  /tmp/dbs1&&mkdir  /tmp/dbs&&killall nun-db|true"]);
