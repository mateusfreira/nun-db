...
mod tests {
    ...
    fn should_return_the_metrics_state() -> Result<(), Box<dyn std::error::Error>> {
        ...
        helpers::nundb_exec_primary("create-db test test-pwd; use-db test test-pwd;set-safe name 1 mateus; set-safe name 2 maria;set-safe name 3 mateus; set-safe name 4 maria;get-safe name");
